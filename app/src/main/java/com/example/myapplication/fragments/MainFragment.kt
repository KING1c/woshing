...
import com.example.myapplication.misc.ServicesAdapter
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        with(binding){
            val adapter = ServicesAdapter(object : ServicesAdapter.Listener{
                override fun toOrder(service: Service) {
                   viewModel.addOrder(service, Date() )
                }
            ...
            buttonMyOrder.setOnClickListener {
                it.findNavController().navigate(R.id.action_mainFragment_to_listOrderFragment)
            }
        }
    }
